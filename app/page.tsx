...
import { SkillsProgressChart } from "@/components/charts/skills-progress-chart"
import { JobMatchChart } from "@/components/charts/job-match-chart"
        ...
        <div className="flex min-h-screen flex-col">
          ...
          <div className="flex-1 space-y-4 p-8 pt-6">
            ...
            <div className="p-8 text-center">
              <h3 className="text-xl font-medium">No student data available</h3>
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <div className="flex-1 space-y-4 p-8 pt-6">
          <div className="flex items-center justify-between space-y-2">
            ...
            {/* Student selector for staff only */}
            {user?.role === "staff" && students.length > 1 && (
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ${selectedStudent.expectedSalary.toLocaleString()}
                      </p>
                    </div>
                    <div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <SkillsProgressChart />
            <SkillsRadarChart student={selectedStudent} />
          </div>
          ...
          <Tabs defaultValue="jobs">
            ...
            <TabsContent value="jobs" className="space-y-4">
              <JobMatchChart student={selectedStudent} />
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <TabsContent value="certifications" className="space-y-4">
              <CertificationMatchChart student={selectedStudent} />
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
